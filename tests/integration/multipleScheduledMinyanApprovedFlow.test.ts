...
describe("multiple minyan schedule flow", () => {
  ...
  it("user approves first minyan by clicking the template button -> gets confirmation message", async () => {
...
`
  ...
  it("user1 selects the forth option - gets a message to add the updated attendees amount", async () => {
